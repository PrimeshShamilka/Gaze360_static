...
out_root = "/media/primesh/F4D0EA80D0EA4906/PROJECTS/FYP/Gaze detection/Datasets/gaze360_preprocessed"
...
def ImageProcessing_Gaze360():
    ...
    for i in range(total_num):
        ...
        cv2.imwrite(os.path.join(out_root, "Image", category, "Face", f"{i+1}.jpg"),
        face)
        cv2.imwrite(os.path.join(out_root, "Image", category, "Left", f"{i+1}.jpg"),
        lefteye)
        cv2.imwrite(os.path.join(out_root, "Image", category, "Right", f"{i+1}.jpg"),
        righteye)
